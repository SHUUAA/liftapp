...
const AppContent: React.FC = () => {
        ...
        if (isRetake) {
            ...
            session = {
                ...
                completionToOverride: {
                    ...
                    oldEffectiveKeystrokes: previousCompletionData.total_effective_keystrokes,
                    oldTotalKeystrokes: previousCompletionData.total_answer_key_keystrokes,
                }
            };
        } else {
  ...
  }, [userId, currentAnnotatorDbId, activeExamSession, addToast, handleSelectExam]);
  ...
  const handleCancelRetake = useCallback(() => {
    ...
    const { completionId, oldStatus, oldImageId, oldDuration, oldCompletedAt, oldRetakeCount, oldEffectiveKeystrokes, oldTotalKeystrokes } = activeExamSession.completionToOverride;

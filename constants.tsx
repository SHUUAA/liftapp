...
const CollectionIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props // Will be used for Confirmation
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
...
const ArchiveBoxIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props // Will be used for Burial
) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10.5 11.25h3M12 15V3.75m0 0H8.25m3.75 0h3.75M3.75 7.5h16.5M12 7.5V3.75"
    />
  </svg>
);
...
export const EXAMS_DATA: Exam[] = [
  {
    ...
    name: "Baptism",
    description:
      "Annotate historical baptismal records. Capture names, dates, and family relations.",
  ...
  },
  {
    ...
    name: "Marriage",
    description:
      "Transcribe marriage records. Note details of spouses, witnesses, and ceremony dates.",
  ...
  },
  {
    ...
    name: "Confirmation",
    description:
      "Extract information from confirmation registers, including names, sponsors, and dates.",
  ...
  },
  {
    ...
    name: "Burial",
    description:
      "Annotate burial records, capturing details of the deceased, death dates, and burial locations.",

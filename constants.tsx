...
const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-3.741-5.602M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 6.75h.008v.008H12v-.008zM12 15h.008v.008H12v-.008zm0-2.25h.008v.008H12V-.008zM12 9.75h.008v.008H12V9.75z" />
  </svg>
);
...
export const EXAMS_DATA: Exam[] = [
  ...
  },
  {
    ...
    icon: <UsersIcon className="w-12 h-12 text-rose-500" />,
  },
  {
    id: 'confirmation',
    name: 'Confirmation',
...
export const ANNOTATION_TABLE_COLUMNS: AnnotationColumn[] = [

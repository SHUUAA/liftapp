  ...
  const handleTimeout = useCallback(async () => {
    ...
    if (submissionSuccessful) {
        ...
        const answerKey: AnnotationRowData[] = (answerRowsData || []).map((dbRow: any) => ({
            id: dbRow.client_row_id || `db_id_${dbRow.id}`, cells: dbRow.row_data
        }));
    ...
    <div className="flex flex-col h-screen bg-slate-100 overflow-hidden">
      ...
      >
        <div className="text-sm text-slate-600 space-y-2 text-left max-h-[60vh] overflow-y-auto pr-2">
            ...
            <p><strong>Timer:</strong> You have {examDurationInMinutes} minutes to complete the exam. If the timer runs out, your work will be automatically submitted, and the exam will be closed.</p>
